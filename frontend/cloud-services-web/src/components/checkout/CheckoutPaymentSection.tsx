...
export function CheckoutPaymentSection({
  ...
  if (isPaid) {
    return (
      <Card className="p-8 md:p-12 rounded-3xl bg-white border border-emerald-200 shadow-md text-center max-w-2xl mx-auto space-y-6 animate-in fade-in zoom-in-95 duration-300">
        <CardHeader className="p-0 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <CardTitle className="text-2xl font-black text-slate-900 font-heading">
              Cảm ơn bạn đã đặt dịch vụ!
            </CardTitle>
            <CardDescription className="text-sm text-slate-600 max-w-md mx-auto leading-relaxed">
  ...
  if (isExpired) {
    return (
      <Card className="p-8 md:p-12 rounded-3xl bg-white border border-rose-200 shadow-md text-center max-w-2xl mx-auto space-y-6">
        <CardHeader className="p-0 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <CardDescription className="text-sm text-slate-500 max-w-md mx-auto leading-relaxed">
  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto">
      ...
      <Card className="p-5 rounded-3xl bg-gradient-to-r from-amber-500/10 via-amber-500/5 to-transparent border border-amber-200/90 shadow-2xs">
      ...
      {activeTab === "qr" ? (
        <Card className="p-6 md:p-8 rounded-3xl bg-white border border-slate-200/90 shadow-sm flex flex-col items-center justify-center text-center space-y-4">
        ...
        <Card className="p-6 md:p-8 rounded-3xl bg-white border border-slate-200/90 shadow-sm space-y-4">
          <CardContent className="p-0">
