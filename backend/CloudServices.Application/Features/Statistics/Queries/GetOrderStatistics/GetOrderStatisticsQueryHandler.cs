...
public sealed class GetOrderStatisticsQueryHandler(IOrderRequestRepository orderRepository, ICacheService cache)
    : IRequestHandler<GetOrderStatisticsQuery, IReadOnlyList<MonthlyOrderStatisticDto>>
{
    ...
    {
        var cacheKey = $"statistics:orders_from_{request.From}_to_{request.To}";
        ...
        return await cache.GetOrCreateAsync(
            ...
            async ct =>
            {
                ...
                var allOrders = await orderRepository.GetAllAsync(ct);
                ...
                return (IReadOnlyList<MonthlyOrderStatisticDto>)result;
            },
